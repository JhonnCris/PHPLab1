...
if (isset($_POST['update'])) {
  ...
  if ($full_name == "" || $email == "") {
    ...
    $sql = "UPDATE clients
            SET client_id='$clientid', full_name='$full_name', email='$email', phone='$phone', address='$address', created_at='$createdat'
            WHERE client_id=$id";
...
<form method="post">
  ...
  <input type="number" name="client_id" value="<?php echo $client['client_id']; ?>"><br><br>
  ...
  <input type="text" name="created_at" value="<?php echo $client['created_at']; ?>"><br><br>
